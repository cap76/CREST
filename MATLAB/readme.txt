...
Calculated indexes for SNNs for each cells (and a control permited set) are saved in the Files folder (C1_set1_withPreImpl_byCl.csv, C1perm_set1_withPreImpl_byCl.csv, S1_set1_all_withPreImpl_byCl.csv)
